// Package config provides configuration management utilities for the 6x-ui panel,
...
// GetVersion returns the version string of the 6x-ui application.
func GetVersion() string {
	return strings.TrimSpace(version)
}

// GetName returns the name of the 6x-ui application.
func GetName() string {
