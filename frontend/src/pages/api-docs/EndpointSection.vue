...
<template>
  <section :id="section.id" class="api-section">
    ...
    <p v-if="section.description && !collapsed" class="section-description"
      v-html="safeInlineHtml(section.description)"></p>
    ...
    <div v-if="section.subHeader && !collapsed" class="sub-header-block">
      ...
      <a-table
        ...
        :data-source="section.subHeader" :pagination="false" size="small" row-key="name">
