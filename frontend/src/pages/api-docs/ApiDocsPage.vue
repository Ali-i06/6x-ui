      ...
      <a-layout class="content-shell">
        <a-layout-content class="content-area">
          <div class="docs-wrapper">
            ...
            <div class="toolbar">
              <a-input-search v-model:value="searchQuery"
                placeholder="Search endpoints by path, method, or description…" allow-clear class="search-bar">
                <template #prefix>
                  <SearchOutlined />
                </template>
              </a-input-search>
            ...
            <nav class="toc-nav">
              ...
              <div class="toc-links">
                <a v-for="s in sections" :key="s.id" class="toc-link" :class="{ active: activeSection === s.id }"
                  :href="`#${s.id}`" @click.prevent="scrollToSection(s.id)">
            ...
            <EndpointSection v-for="s in sections" :key="s.id" :section="s" :icon="sectionIcons[s.id]"
              :collapsed="isCollapsed(s.id)" @toggle="toggleSection(s.id)" />
          </div>
        </a-layout-content>
      </a-layout>
    </a-layout>
